...
<?= load_partial('top-layout', ['page_title' => 'سبد خرید، پر از خالی!', 'body_styles' => "h-dvh flex justify-between flex-col"]) ?>
<div>
  <?= load_partial('header') ?>
      ...
      <div class="w-1/2 space-y-4">
        ...
        <div class="text-center space-y-2">
          <p>
            ...
            عزیز، سبد خرید شما خالی‌ست! پیشنهاد می‌کنیم از محصولات و کتاب‌های ما دیدن کنید و خرید خود را شروع کنید.
          </p>
