...
load_partial('top-layout', [
  'page_title' => 'پنل | کتاب‌های شما | کتاب جدید',
]);
?>
    ...
    <section class="mt-4">
      <form action="/book/create" method="post" enctype="multipart/form-data">
        <div class="w-lg grid grid-cols-2 gap-y-2 items-start">
          ...
          <input type="file" name="image" id="image" class="file-input file-input-secondary" />
          ...
          <input type="text" name="author" id="author" class="input input-secondary" value="<?= $old_data['author'] ?? '' ?>">
          ...
          <textarea
            ...
            name="description"
            id="description"
            placeholder="توضیحاتی راجب کتاب بنویسید..."></textarea>
          ...
          <label for="categories" class="label">دسته بندی</label>
          <input type="text" name="categories" id="categories" class="input input-secondary" placeholder="دسته‌ها را با ویرگول از هم جدا کنید (فلسفه، تاریخ، فانتزی)">
          <?php if (isset($errors['genre']) and !empty($errors['genre'])) : ?>
            <div role="alert" class="alert alert-error alert-soft mt-1 col-span-2">
          ...
          <input type="text" name="isbn" id="isbn" class="input input-secondary">
          ...
          <input type="date" name="published_at" id="published_at" class="input input-secondary">
          ...
          <input type="number" name="price" id="price" class="input input-secondary">
          ...
          <input type="number" name="stock" id="stock" class="input input-secondary">
